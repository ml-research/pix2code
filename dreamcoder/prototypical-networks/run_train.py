...
import scripts.train.few_shot
from scripts.train.few_shot.train import main

parser = argparse.ArgumentParser(description="Train prototypical networks")

# data args
default_dataset = "geometry"
default_split = "sable-meyer"
parser.add_argument(
    "--data.dataset",
    type=str,
...
parser.add_argument(
    "--data.cuda", action="store_true", help="run in CUDA mode (default: False)"
)
...
parser.add_argument(
    ...
    metavar="EXP_DIR",
    help="directory where experiments should be saved (default: {:s})".format(
        default_exp_dir
    ),
)

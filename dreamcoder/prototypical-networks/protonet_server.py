...
from protonet_score import (PretrainedProtonetDistScore, load_image,
                            load_image_path)

cache = {}
model = PretrainedProtonetDistScore(
    os.path.dirname(os.path.realpath(__file__)) + "/results-OM/best_model.pt"
)

...
def makeNewNumberTasks():
    ...
    numberTasks = [
        t
        for t in tasks
        if not any(p in ex for p in printable[10:62] for _, ex in t.examples)
    ]
    return numberTasks
...
if __name__ == "__main__":
    ...
    parser.add_argument("--include_only", default=None, nargs="+", type=int)
